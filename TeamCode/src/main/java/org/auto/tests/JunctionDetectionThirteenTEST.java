...
import org.firstinspires.ftc.teamcode.vision.JunctionDetection13356;
...
@Autonomous
public class JunctionDetectionThirteenTEST extends LinearOpMode {
        JunctionDetection13356 junctionDetection13356;
        OpenCvCamera camera;
        ...
        public void runOpMode() {
            ...
            junctionDetection13356 = new JunctionDetection13356();
            ...
            while (!isStarted() && !isStopRequested()) {
                if (junctionDetection13356.done) {
                    ...
                    telemetry.addLine(junctionDetection13356.start + " " + junctionDetection13356.middle + " " + junctionDetection13356.end);
                } else {
