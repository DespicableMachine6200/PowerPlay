...
@Autonomous
public class AutoBlueLeft1Cone extends LinearOpMode {
        ...
        if(tagOfInterest != null){
            if (tagOfInterest.id == LEFT) {
                seq1 = robot.trajectorySequenceBuilder(new Pose2d(35, 60, Math.toRadians(270)))
                        ...
                        .UNSTABLE_addTemporalMarkerOffset(-4, () -> robot.lmotor.setTargetPosition(3000))
                        .UNSTABLE_addTemporalMarkerOffset(-4, () -> robot.lmotor.setPower(0.95))
                        .forward(4)
                        // drop cone 1
            ...
            //failsafe trajectories - randomly goes to #1
            seq1 = robot.trajectorySequenceBuilder(new Pose2d(35, 60, Math.toRadians(270)))
                    .addTemporalMarker(() -> robot.servo.setPosition(maxPosition))
                    .turn(Math.toRadians(-90))
                    .forward(22)
